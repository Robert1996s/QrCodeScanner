...
class MainActivity : AppCompatActivity() {
    ...
    private val reqCodeCameraPermission = 1001
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val aniSlide: Animation = AnimationUtils.loadAnimation(this@MainActivity,
    ...
    private fun setUpControls() {
        ...
        binding.cameraSurfaceView.getHolder().addCallback(object : SurfaceHolder.Callback {
            ...
            override fun surfaceCreated(holder: SurfaceHolder) {
                try {
                    //start preview after first delay
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == reqCodeCameraPermission && grantResults.isNotEmpty()) {
